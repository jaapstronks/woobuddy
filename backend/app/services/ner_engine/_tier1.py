...
_PHONE_PATTERNS = [
    ...
    re.compile(  # (0592) 365 555
        r"(?<!\w)(\(0[1-9]\d{2}\)" + _P + r"\d{3}" + _P + r"\d{3})(?!\w)"
    ),
    re.compile(  # (033) 421 4567
        r"(?<!\w)(\(0[1-9]\d\)" + _P + r"\d{3}" + _P + r"\d{4})(?!\w)"
    ),
    re.compile(  # (0592) 365555 / (033) 4214567
        r"(?<!\w)(\(0[1-9]\d{2}\)" + _P + r"\d{6}|\(0[1-9]\d\)" + _P + r"\d{7})(?!\w)"
    ),
